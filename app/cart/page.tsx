      ...
      <div className="max-w-6xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          <div className="bg-white rounded-[2.5rem] p-16 text-center border border-dashed border-gray-200 shadow-sm">
            ...
            <p className="text-xl font-black text-gray-900 mb-2 text-center">
              السلة فارغة حاليًا
            </p>
            <p className="text-gray-400 font-bold mb-8 text-center">
              ابدأ بإضافة بعض المنتجات الرائعة لسيارتك
            </p>
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 bg-gray-900 text-white px-10 py-4 rounded-2xl font-black transition-all active:scale-95 shadow-xl shadow-gray-200"
            >
              تصفح المتجر
                  ...
                  >
                    ...
                    <div className="flex-1 text-center sm:text-right">
                      ...
                      <div className="inline-flex items-center bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center bg-white rounded-lg text-gray-500 hover:text-blue-600 shadow-sm active:scale-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                          <Plus size={14} />
                        </button>
                      </div>
                    ...
                    <div className="flex flex-row sm:flex-col items-center justify-between sm:justify-center gap-4 w-full sm:w-auto sm:border-r sm:pr-6 sm:mr-2 border-gray-100">
                      <div className="text-left sm:text-right">
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-1 text-center">
                          إجمالي الصنف
                        </p>
            ...
            <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl shadow-gray-100/50 sticky top-28">
              ...
              <div className="space-y-4 mb-8">
                {cartItems.map((item: any) => (
                  <div
                    key={item.id}
                    className="flex justify-between items-start text-sm pb-4 border-b border-gray-50 last:border-0 last:pb-0"
                  >
                    <div>
