...
export const metadata: Metadata = {
  ...
  description:
    "اقرأ إجابات الأسئلة الشائعة عن متجر سيزر في مصر، شامل المنتجات، طريقة الطلب، الشحن، الدفع، التوفر، الاستبدال، الإرجاع، وطرق التواصل.",
  alternates: {
    canonical: "/faq",
  },
  openGraph: {
    ...
    description:
      "تعرف على أهم أسئلة عملاء Cesar Store عن منتجات السيارات، الأسعار، التوفر، الطلب، الشحن، الدفع عند الاستلام، الاستبدال، والتواصل.",
    url: absoluteUrl("/faq"),
    siteName: SITE_NAME,
    type: "website",
  },
