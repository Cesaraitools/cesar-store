            ...
            <CartProvider>
              <CheckoutProvider>
                <div className="flex flex-col min-h-screen">
                  ...
                  />
                  <footer className="bg-white border-t border-slate-100 py-10 text-center text-sm font-medium text-slate-500">
                    <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-4">
                      ...
                      <div className="my-2 flex flex-wrap items-center justify-center gap-4">
                        ...
                        >
                          <Phone size={18} className="text-slate-400 transition-colors group-hover:text-blue-500" />
                        ...
                        <a
                          ...
                          className="group flex h-11 items-center gap-2 rounded-xl border border-slate-100 bg-slate-50/50 px-4 text-slate-600 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-100 hover:bg-blue-50/30 hover:text-blue-600 hover:shadow-md"
                        >
                          <Mail size={18} className="text-slate-400 transition-colors group-hover:text-blue-500" />
                        ...
                        >
                          <MessageCircle size={18} className="text-slate-400 transition-colors group-hover:text-emerald-500" />
