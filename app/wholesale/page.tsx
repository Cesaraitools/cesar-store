...
const steps = [
  ...
  },
  {
    ...
    description: "بعد الموافقة يتم تفعيل دخول الجملة وإتاحة الأسعار ووحدات البيع.",
    icon: LockKeyhole,
  },
];
        ...
        <div className="space-y-7">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-600 md:text-lg">
              أسعار الجملة ووحدات البيع الخاصة تظهر فقط للكيانات المعتمدة بعد
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/70">
          <div className="rounded-xl bg-slate-950 p-6 text-white">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              ...
              بأسعار ووحدات بيع مختلفة عن القطاعي.
            </p>
          </div>
